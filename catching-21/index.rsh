 ...
 * Catching 21
 * 
 * The goal of the game is to have a hand with a value as close to 21 as possible without exceeding it. 
 * The player takes their turn first, deciding whether to "hit" and receive another card, or "stay" and 
 * lock in their current total. Once the player stays, the dealer takes over, playing automatically. 
 * The dealer continues to draw cards until their total surpasses the player's or exceeds 21. To account for 
 * their "house" advantage, the dealer contributes an extra 5 ALGO fee. The game operates as a match, with the 
 * first player to win 3 hands claiming victory. Upon the match's conclusion, the contract balance is 
